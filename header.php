...
<header id="site-header" class="fixed z-[9999] w-full h-[91px] flex items-center bg-transparent duration-300">
        ...
        <div class="flex justify-between items-center">
            <a href="/" class="logo">
                <div class="flex items-center">
                    ...
                    <div class="ml-[7px]">
                        <p class="font-britti text-26 leading-26 font-normal text-donkergroen">ArtroQare</p>
                    </div>
                </div>
            </a>
            <?php
            if( have_rows('hoofdmenu', 'option') ):
                ...
                <div class="relative hover-dropdown pt-1">
                     <a href="<?php echo $link_url; ?>" class="hidden md:block md:text-18 md:leading-18 lg:text-24 lg:leading-24 font-britti font-normal text-donkergroen hover:text-[#95CD6C] duration-300 pb-1" target="<?php echo $link_target; ?>"><?php echo $link_text; ?></a>
                        ...
                        <ul class="dropdown-menu absolute hidden bg-white py-[25px] px-[20px] border-[20px]">
                            ...
                            if( have_rows('submenu') ):
                                ...
                                ?>
                                <li class=""><a class="md:text-18 md:leading-44 lg:text-24 lg:leading-44 font-britti font-normal text-donkergroen hover:text-[#95CD6C] duration-300" href="<?php echo $link1_url; ?>" target="<?php echo $link1_target; ?>"><?php echo $link1_text; ?></a></li>
                                <?php
                                endwhile;
                            else :
                            endif;
            ...
            <a href="<?php echo $link_url; ?>" class="hidden md:flex w-fit h-[45px] px-[15px] bg-[#FFE863] rounded-[6px] items-center font-britti font-normal md:text-19 lg:text-22 text-donkergroen hover:bg-[#95CD6C] duration-300"><?php echo $link_text; ?>
                <div class="ml-[15px]">
    ...
    <div class="menu w-sreen blur-header pt-7 px-2 flex flex-col w-full z-50 h-auto pb-[38px] md:hidden">
        <div class="container mt-[31px]">
            ...
            <?php if (get_field('cta_link', 'option')): ?>   
            <a href="<?php echo $link_url; ?>" class="flex w-fit h-[45px] px-[15px] bg-[#FFE863] rounded-[6px] items-center font-britti font-normal md:text-19 lg:text-22 text-donkergroen mt-[29px]"><?php echo $link_text; ?>
                <div class="ml-[15px]">
                    <svg width="15px" height="12.862883px" viewBox="0 0 15 12.862883" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="arrow-right-solid" fill="#064F51" fill-rule="nonzero">
