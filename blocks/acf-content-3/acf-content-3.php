...
if (isset($block['data']['preview_image_help'])): ?>
    ...
    <section class="bg-geel py-4 md:pt-5 md:pb-[55px] lg:pb-[75px] lg:pt-8 xl:pb-[65px]">
        <div class="container lg:max-w-[645px]">
            <h3 class="text-[#064F51] text-40 leading-40 pb-2 md:pb-3 md:text-45 md:leading-40 lg:pb-6 lg:text-82 lg:leading-78 xl:text-85">Behandeling</h3>
